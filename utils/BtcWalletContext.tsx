...
export const BtcWalletContext = React.createContext({} as ReturnType<typeof useValue>)

export const BtcWalletProvider: React.FC<React.PropsWithChildren<any>> = (props) => {
    
    return (
        <BtcWalletContext.Provider value={useValue()}>
            {props.children}
